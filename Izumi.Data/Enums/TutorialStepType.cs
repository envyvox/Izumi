    ...
    public static class TutorialStepHelper
    {
        ...
        public static string Description(this TutorialStepType step) => step switch
        {
            ...
            TutorialStepType.CheckCookingList =>
                ...
                "\n\nНапиши в канал <#879838888296857630> `/приготовление` и выбери **блюда начинающего повара** из списка вариантов.",
            ...
            TutorialStepType.Completed =>
                ...
                "чтобы получать немного <:Ien:813145486428995635> валюты каждый день." +
                "\n\nДалее дело за тобой, но я всегда буду на связи. Буду рада тебе помочь, стоит тебе только написать `/помощь`." +
                "\n\nИ еще кое-что! У меня есть <#750624434179801108>, где я буду рассказывать обо всем интересном, " +
