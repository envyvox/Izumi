...
{
    public record ShopRecipeBuyCommand(SocketSlashCommand Command) : IRequest;

    public class ShopRecipeBuyHandler : IRequestHandler<ShopRecipeBuyCommand>
    {
        private readonly IMediator _mediator;
        private readonly ILocalizationService _local;

        public ShopRecipeBuyHandler(
            IMediator mediator,
        ...
        public async Task<Unit> Handle(ShopRecipeBuyCommand request, CancellationToken ct)
        {
