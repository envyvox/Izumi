...
{
    public record MarketBuyCommand(SocketSlashCommand Command) : IRequest;

    public class MarketBuyHandler : IRequestHandler<MarketBuyCommand>
    {
        private readonly IMediator _mediator;
        private readonly ILocalizationService _local;

        public MarketBuyHandler(
            IMediator mediator,
        ...
        public async Task<Unit> Handle(MarketBuyCommand request, CancellationToken ct)
        {
